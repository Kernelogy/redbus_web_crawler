...
def mergeData(file_path1, file_path2, target_file_path):
    ...
    all_data = all_data.combine(df1,ignore_index=True)
    all_data = all_data.combine(df2,ignore_index=True)

    all_data.to_excel(target_file_path, sheet_name = 'Sheet1', index = False)

if __name__ == "__main__":        

    # file_path1 = r"C:\Users\mukilan\Desktop\Data1.xlsx"
    # file_path2 = r"C:\Users\mukilan\Desktop\Data2.xlsx"

    # target_file_path = r"C:\Users\mukilan\Desktop\Combined.xlsx"

    file_path1 = r"/home/edexadm/learn/projects/redbusgrabber/data/Data1.xlsx"
    file_path2 = r"/home/edexadm/learn/projects/redbusgrabber/data/Data2.xlsx"
    target_file_path = r"/home/edexadm/learn/projects/redbusgrabber/data/Combined.xlsx"
